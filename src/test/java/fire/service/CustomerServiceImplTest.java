...
public class CustomerServiceImplTest {
  ...
  public void validateBundleAgainstQuestions() throws Exception {
    ...
    try {
      ...
      assertEquals("Age should be < 18", e.getMessage());
    }
    // Junior Saver allowed (age < 18 and student = true)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.JUNIOR_SAVER.getBundleName(), 17, true, 0));
    ...
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.JUNIOR_SAVER.getBundleName(), 17, false, 1));
    // Junior Saver not allowed (age > 17 and income > 0 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.JUNIOR_SAVER.getBundleName(), 18, false, 1);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be < 18", e.getMessage());
    }
    // Junior Saver allowed (age < 18 and income > 0 and student = true)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.JUNIOR_SAVER.getBundleName(), 17, true, 1));
    // Junior Saver not allowed (age > 17 and income > 0 and student = true)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.JUNIOR_SAVER.getBundleName(), 18, true, 1);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be < 18", e.getMessage());
    }
    ...
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.STUDENT.getBundleName(), 18, true, 0));
    // Student not allowed (age < 18 and student  = true)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.STUDENT.getBundleName(), 17, true, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    // Student not allowed (age > 17 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.STUDENT.getBundleName(), 18, false, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Customer is not a student", e.getMessage());
    }

    // Classic allowed (age > 17 and income > 0 and student = false)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 18, false, 1));
    // Classic not allowed (age > 17 and income < 1 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 18, false, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 0", e.getMessage());
    }
    // Classic not allowed (age < 18 and income > 0 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 17, false, 1);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 17, false, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    // Classic allowed (age > 17 and income > 0 and student = true)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 18, true, 1));
    // Classic not allowed (age > 17 and income < 1 and student = true)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 18, true, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 0", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 17, true, 1);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC.getBundleName(), 17, true, 0);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 18, false, 12001));
    // Classic Plus allowed (age < 18 and income > 12000 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 17, false, 12001);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 18, false, 12000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 12000", e.getMessage());
    }
    // Classic Plus allowed (age < 18 and income < 12001 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 17, false, 12000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    // Classic Plus allowed (age > 17 and income > 12000 and student = true)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 18, true, 12001));
    // Classic Plus allowed (age < 18 and income > 12000 and student = true)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 17, true, 12001);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 18, true, 12000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 12000", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.CLASSIC_PLUS.getBundleName(), 17, true, 12000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 18, false, 40001));
    // Gold allowed (age < 18 and income > 40000 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 17, false, 40001);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 18, false, 40000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 40000", e.getMessage());
    }
    // Gold allowed (age < 18 and income < 40001 and student = false)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 17, false, 40000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    // Gold allowed (age > 17 and income > 40000 and student = true)
    assertTrue(customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 18, true, 40001));
    // Gold allowed (age < 18 and income > 40000 and student = true)
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 17, true, 40001);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 18, true, 40000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Income should be > 40000", e.getMessage());
    }
    ...
    try {
      customerService.validateBundleAgainstQuestions(BundleEnum.GOLD.getBundleName(), 17, true, 40000);
      fail();
    } catch (CustomerException e) {
      assertEquals("Age should be > 17", e.getMessage());
    }
    ...
    try {
      ...
      assertEquals("Invalid bundle name", e.getMessage());
    }
  }
  ...
  public void getRecommendedBundle() throws Exception {
    ...
    try {
      ...
      assertEquals("No Bundle available", e.getMessage());
    }
    ...
    try {
      ...
      assertEquals("Age can't be < 0", e.getMessage());
    }
  }
